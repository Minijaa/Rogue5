...
public class Map {
    ...
    void setActivePlayerLocation(int x, int y) {
        activePlayerLocation = mapGrid[x][y];
        activePlayerLocation.setPlayerAtLocation();
    }

    Location getActivePlayerLocation() {
        return activePlayerLocation;
    }

    Location getLocationFromPoint(Point gridPoint) {
    ...
    void addMonsterToList(Monster monster) {
        monsterList.add(monster);
    }

    Monster removeMonster(Monster monsterToBeRemoved) {
    ...
    Monster getMonsterFromList(int index) {
